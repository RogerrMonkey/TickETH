        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-muted hover:text-primary transition-colors duration-300 hover:drop-shadow-[0_0_6px_rgba(108,99,255,0.4)]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://discord.com" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-muted hover:text-accent transition-colors duration-300 hover:drop-shadow-[0_0_6px_rgba(0,217,255,0.4)]">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted hover:text-foreground transition-colors duration-300 hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.2)]">
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm text-muted">
              <p><Link href="#" className="hover:text-primary transition-colors duration-300">Terms of Service</Link></p>
              <p><Link href="#" className="hover:text-primary transition-colors duration-300">Privacy Policy</Link></p>
            </div>
          </div>
        </div>
